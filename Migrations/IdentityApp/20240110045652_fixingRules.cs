...
{
    public partial class fixingRules : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Processes_Languages_LanguageId",
                table: "Processes",
                column: "LanguageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcessQuestion", x => new { x.ProcessesProcessId, x.QuestionsQuestionId });
                    table.ForeignKey(
                        name: "FK_ProcessQuestion_Processes_ProcessesProcessId",
                        column: x => x.ProcessesProcessId,
                        principalTable: "Processes",
                        principalColumn: "ProcessId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProcessQuestion_Questions_QuestionsQuestionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Processes_LanguageId",
                table: "Processes",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_ProcessQuestion_QuestionsQuestionId",
                table: "ProcessQuestion",
